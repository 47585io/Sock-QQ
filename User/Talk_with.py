...
class Talk_with(Friend_list):
    ...
    def talk_with(self, name):
        ...
        self.ent.bind("<Return>", lambda x, y=name: self.Sendshow(x, y,self.ent.get()))
    ...
    def Sendshow(self, tmp, name,s_str):
        ...
        if self.Canv_y>self.Win_Size[0][1]:
            self.f_can.configure(scrollregion=(0,0,500,self.Canv_y-self.Win_Size[0][1]+self.pic_size[1]))
